...
// QIIME_ITSXPRESS_SE was intentionally removed from the active workflow.
// ITSxpress is run only from paired-end input. For --analysis_mode single,
// the paired-end ITSxpress-trimmed artifact is routed to DADA2 single-end
// denoising by the QIIME_PREPROCESS subworkflow.
